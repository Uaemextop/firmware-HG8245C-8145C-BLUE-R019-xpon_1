...
var AllSimulateResults = new Array(4);
...
function SubmitStartSimulateTest()
{
    ...
    setLastestPhyIndexCookie('SimulateTestSelect', PhyReferenceIndex);
    Form.submit(); 
}
...
var RingResistance = new Array(4);
...
{ 
    ...
    {
        setLastestPhyIndexCookie('SimulateTestSelect', SimSelValue);
    }    
