...
<body onLoad="LoadFrame();"> 
	...
	<div class="func_title" BindText="s2004" style="margin-top:20px;"></div><!-- function 2: Warranty Disclaimer -->
	<table width="100%" border="0" cellpadding="0" cellspacing="1"> 
		<tr><td id="title_02" class="table_title width_per30 copyrightinfo_title_bold" BindText="s2005"></td></tr> 
	</table> 
	
	<div class="func_spread"></div>
	<div class="func_title" BindText="s2050" style="margin-top:20px;"></div><!-- function 5: Copyright Notice and License Texts -->
	<table width="100%" border="0" cellpadding="0" cellspacing="1"> 
		<tr>
		<script>
	...
	<div class="func_spread"></div>
	<div class="func_title" BindText="s2006" style="margin-top:20px;"></div><!-- function 3: Open Source Software Information -->
	<div id="OpenSFInfo"> 
	...
	<div class="func_spread"></div>
	<div class="func_title" BindText="s2012" style="margin-top:20px;"></div><!-- function 4: Written Offer -->
	<table width="100%" border="0" cellpadding="0" cellspacing="1"> 
		<script>
			if( 1 == SingtelFlag )
			{
