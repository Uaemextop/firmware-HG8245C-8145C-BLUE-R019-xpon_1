...
<script language="JavaScript" src="<%HW_WEB_GetReloadCus(html/ssmp/sntp/sntp.cus);%>"></script>
<style>
.sntpselectdefcss{
	width:260px;
}
...
var SmartFlag  = '<%HW_WEB_GetFeatureSupport(FT_SMART_BOARD);%>';
...
function stTimeInfo(domain,Enable,ntp1,ntp2,ntp3,ntp4,ZoneName,SynInterval,WanName,DstUsed,StartDate,EndDate,StartDate_EX,EndDate_EX)
{
	this.domain = domain;
	this.Enable = Enable;
	this.ntp1   = ntp1;
...
var TimeInfos = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.Time,Enable|NTPServer1|NTPServer2|NTPServer3|NTPServer4|LocalTimeZoneName|X_HW_SynInterval|X_HW_WanName|DaylightSavingsUsed|DaylightSavingsStart|DaylightSavingsEnd|X_HW_DaylightSavingsStartDate|X_HW_DaylightSavingsEndDate,stTimeInfo);%>;
