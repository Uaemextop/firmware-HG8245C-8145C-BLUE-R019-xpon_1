...
function showtime()
{
	...
	{
		window.location.replace("sntpsmart.asp");
	}
...
function SubmitForm()
{
	...
	Form.setAction('set.cgi?x=InternetGatewayDevice.Time&RequestFile=html/ssmp/sntp/sntpsmart.asp');
...
function SubmitDSTForm()
{
	...
	Form.endPrefix();
	Form.addParameter('x.X_HW_Token', getValue('onttoken'));
	Form.setAction('set.cgi?y=InternetGatewayDevice.Time&RequestFile=html/ssmp/sntp/sntpsmart.asp');
