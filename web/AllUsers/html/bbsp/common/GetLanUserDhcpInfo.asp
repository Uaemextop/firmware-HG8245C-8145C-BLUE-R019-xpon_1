...
var UserDhcpinfo = <%HW_WEB_GetSpecParaArryByDomain(HW_WEB_SpecialGetUserDevInfo,InternetGatewayDevice.LANDevice.1.Hosts.Host.{i},HostName|IPAddress|MACAddress|LeaseTimeRemaining|VendorClassID|InterfaceType|AddressSource, DHCPInfo);%>;
