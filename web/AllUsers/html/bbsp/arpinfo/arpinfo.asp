...
function shoulist(startlist , endlist)
{
	...
	{
		document.write("<tr class=\"tabal_01 align_center\" >");
		document.write('<td>'+ htmlencode(NeighInfo[i].IPAddress) +'</td>');
		document.write('<td>'+ htmlencode(NeighInfo[i].MACAddress) +'</td>');
		document.write('<td>'+ htmlencode(NeighInfo[i].Interface) +'</td>');
		document.write('<td>'+ htmlencode(NeighInfo[i].Status) +'</td>');
		document.write("</tr>");
	}
}
