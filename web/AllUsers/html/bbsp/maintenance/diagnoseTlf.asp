	...
	<table width="100%" class="setupWifiTable setTable"> 
        <tr > 
          <td colspan="2" class="td_button">
			...
			<button id="btnApply_ex" name="btnApply_ex" type="button" class="btn-default-orange-small right" onClick="onApply();"><span><script>document.write(diagnose_language['bbsp_test']);</script></span></button> 
		</td> 
        </tr>
	</table>
