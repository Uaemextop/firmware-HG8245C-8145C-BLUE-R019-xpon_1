	...
	<script language="JavaScript" type="text/javascript"> 
		function FillDhcpInfo(info)
		{
			...
			for(i=0;i<info.length-1;i++)
			{
				...
				result += "<tr class='tabal_01 align_center'><td>"+GetStringContent(htmlencode(info[i].name), MAX_HOST_TYPE)+"</td>";
				result += "<td>"+info[i].ip+"</td>";
				result += "<td>"+info[i].mac+"</td>";
				result += "<td>"+info[i].remaintime+dhcpinfo_language['bbsp_sec']+"</td>";
				result += "<td>"+GetStringContent(htmlencode(info[i].devtype), MAX_DEV_TYPE)+"</td></tr>";
			}
