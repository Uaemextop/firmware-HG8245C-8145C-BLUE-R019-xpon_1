...
<div id="userinfo">
	<div id="username" class="contentItem nofloat">
		...
		<div class="contenbox nofloat">
			<input type="text" disabled="disabled" id="AccountValue" name="AccountValue" style="line-height:34px;" class="textboxbg" maxlength="64"/>
		</div>
	</div>
	<div id="userpwd" class="contentItem nofloat">
		<div class="labelBox"><span id="userpassword" BindText="bbsp_pwd"></span></div>
		<div class="contenbox nofloat"><input type="password" id="PwdValue" name="PwdValue" class="textboxbg" style="font-size:14px;line-height:34px;" maxlength="64"/></div>
	</div>
